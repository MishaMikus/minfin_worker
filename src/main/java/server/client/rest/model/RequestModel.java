...
public class RequestModel {
    ...
    private List<FileWrapper> multipartFileList;
    ...
    public List<FileWrapper> getMultipartFileList() {
        return multipartFileList;
    }

    public void setMultipartFileList(List<FileWrapper> multipartFileList) {
